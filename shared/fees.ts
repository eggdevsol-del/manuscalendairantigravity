...
export const PAYMENT_TIERS: Record<PaymentTier, TierPaymentConfig> = {
  ...
  pro: {
    platformFeeRate: 0.034,
    artistFeeRate: 0.0,
    subscriptionPriceCents: 9900, // A$99/month
  ...
  top: {
    platformFeeRate: 0.034,
    artistFeeRate: 0.0,
    subscriptionPriceCents: 49900, // A$499/month, up to 10 active artists
    defaultDepositPercent: 25, // Default, configurable
    depositCustomisable: true,
    upfrontPaymentAllowed: true, // Includes Pro payment benefits
    label: "Studio",
  },
};
