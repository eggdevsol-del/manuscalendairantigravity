...
export const cases=[
 ...
 {name:'project-files',path:'/projects/12',open:[async page=>page.locator('.ivory-project-resource > summary').filter({hasText:'Design & references'}).first().click()]},
 {name:'project-payments',path:'/projects/12',open:[async page=>page.locator('.ivory-project-resource > summary').filter({hasText:/^Payments$/}).first().click()]},
