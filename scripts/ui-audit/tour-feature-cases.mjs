...
export const cases=[
 ...
 {name:'tabs-bookings-past',role:'client',path:'/bookings',open:[async page=>page.locator('.ivory-completed-projects > summary').click()]},
 ...
 {name:'project-files',path:'/projects/12',open:[async page=>page.locator('.ivory-project-disclosure > details > summary').first().click(),async page=>page.locator('.ivory-project-resource > summary').filter({hasText:'Design & references'}).first().click()]},
 {name:'project-payments',path:'/projects/12',open:[async page=>page.locator('.ivory-project-disclosure > details > summary').first().click(),async page=>page.locator('.ivory-project-resource > summary').filter({hasText:/^Payments$/}).first().click()]},
