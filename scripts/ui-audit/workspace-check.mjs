...
const cases = process.env.WORKSPACE_QUICK
  ? [["ipad", 1180, 820, 24, 20, "artist", "/calendar"]]
  : [
      ["iphone", 440, 956, 62, 34, "artist", "/dashboard"],
      ["ipad", 1180, 820, 24, 20, "artist", "/calendar"],
      ["ipad-portrait", 820, 1180, 24, 20, "artist", "/calendar"],
      ["iphone", 440, 956, 62, 34, "artist", "/clients"],
      ["iphone", 440, 956, 62, 34, "client", "/bookings"],
      ["iphone", 440, 956, 62, 34, "client", "/projects/12"],
      ["ipad", 1180, 820, 24, 20, "artist", "/projects/12"],
      ["ipad", 1180, 820, 24, 20, "artist", "/conversations"],
      ["iphone", 440, 956, 62, 34, "artist", "/business"],
    ];
...
if (results.some(r => r.errors.length || r.overflow || !r.headers.length))
  process.exitCode = 1;
