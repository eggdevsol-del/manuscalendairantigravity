    ...
    >
      ...
      {Icon && (
        <div
          className={cn(
            ...
            selected
              ? tokens.selectionCard.iconContainer.selected
              : tokens.selectionCard.iconContainer.idle
          )}
        >
      ...
      <div className="flex-1">
        <h3
          className={cn(
            ...
            selected
              ? tokens.selectionCard.title.selected
              : tokens.selectionCard.title.idle
          )}
        >
          {title}
        </h3>
        {description && (
          <div className={tokens.selectionCard.description}>{description}</div>
        )}
      </div>
      ...
      <div
        className={cn(
          ...
          selected
            ? tokens.selectionCard.indicator.selected
            : tokens.selectionCard.indicator.idle
        )}
      >
