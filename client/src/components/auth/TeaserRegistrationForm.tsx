  ...
  return (
    <Card className="w-full max-w-md bg-background border-border shadow-xl rounded-[4px] overflow-hidden">
      ...
      <CardContent className="px-8 pb-8 space-y-6">
        ...
        {/* Email/Password Form — shown by default if Google isn't ready, or toggled open */}
        {(!isGoogleReady || showEmailForm) ? (
            ...
            {(!emailStatus?.exists || emailStatus.isFunnelClient) && (
              ...
              >
                {isLoading ? (
                  ...
                  "Register & View Dashboard"
                )}
              </Button>
            )}
          </form>
        ) : (
          /* Show expand button when Google is ready but form is hidden */
          <button
