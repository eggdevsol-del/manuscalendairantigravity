...
export function ConsultationSettings({ onBack }: ConsultationSettingsProps) {
        ...
        <div className="pb-[180px] max-w-lg mx-auto space-y-4 px-4 pt-6">
          ...
          {isLoading ? (
            ...
            consultations.map(consultation => (
              <div
                key={consultation.id}
                className="group bg-transparent hover:bg-secondary/50 transition-colors cursor-pointer border-b border-border pb-4 pt-4 last:border-0 relative overflow-hidden"
                onClick={() => {
