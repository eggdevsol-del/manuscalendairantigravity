                ...
                <div className="pb-[180px] max-w-lg mx-auto space-y-6 px-4 pt-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            {/* Google Maps Preview */}
                            {businessAddress && (
                                <div className="mt-3 rounded-md overflow-hidden border border-border h-40 bg-background/80 relative group">
                                    <iframe
                                        width="100%"
                                        height="100%"
                                        frameBorder="0"
                            ...
                            {(!artistSettings?.subscriptionTier || artistSettings.subscriptionTier === "basic") ? (
                                <>
                                    <div className="flex items-center gap-3 p-3 rounded-md bg-secondary/50 border border-border">
                                        <div className="flex items-center justify-center w-10 h-10 rounded-md bg-[var(--color-status-warning-bg)] text-[var(--color-status-warning-text)] shrink-0">
