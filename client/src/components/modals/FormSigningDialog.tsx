...
export function FormSigningDialog({
  ...
  const [step, setStep] = useState<"content" | "signature">(
    viewOnly ? "content" : "content"
  );
  ...
  return (
    <Dialog open={isOpen} onOpenChange={open => !open && onClose()}>
      <DialogContent className="max-w-xl p-0 overflow-hidden bg-background border-border h-[90dvh] flex flex-col">
