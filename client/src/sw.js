...
// The new SW will wait until the user acknowledges the update banner,
// which sends a SKIP_WAITING message (handled below). This prevents
// the app from reloading mid-session without user consent.
clientsClaim();
...
// Do NOT call skipWaiting() here. The UpdateBanner in the UI will
// send a SKIP_WAITING message when the user taps "Update Now".
// Public pages (/book/:slug) handle this client-side by auto-sending
// SKIP_WAITING on mount since they have no UpdateBanner.
