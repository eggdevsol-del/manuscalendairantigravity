...
// Public pages (e.g. /book/:slug) have no UpdateBanner to send SKIP_WAITING,
// so deferring activation causes stale caches on those routes.
// The activate handler already calls clients.claim() to take control.
