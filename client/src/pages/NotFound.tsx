        ...
        <CardContent className="pt-8 pb-8 text-center">
          <div className="flex justify-center mb-6">
            <div className="relative">
              <div className="absolute inset-0 bg-[var(--color-status-danger-bg)] rounded-full animate-pulse" />
              <AlertCircle className="relative h-16 w-16 text-[var(--color-status-danger-text)]" />
            </div>
          </div>
