  ...
  return (
    <div className={artistProfile.theme === "dark" ? "dark" : ""}>
      <div className="min-h-[100dvh] w-full flex flex-col bg-background font-sans relative">
        ...
        {/* Content */}
        <div className="pt-20 pb-32 px-6 max-w-lg mx-auto relative z-10" style={{ width: '337.453125px', height: currentStep === 1 ? '208px' : '472px', transform: 'translate(0px, 110px)', borderRadius: '6px' }}>
