  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const submitData = {
        ...
        import { trpc } from "@/lib/trpc"; // Add import
        ...
        const handleSubmit = async () => {
          try {
            ...
            const submitData: FunnelStepData = {
              intent: {
                projectType,
                projectDescription,
              },
              ...
              style: {
                stylePreferences: selectedStyles,
                referenceImages: referenceUrls, // Use processed URLs
              },
              bodyPlacement: {
                placementImages: placementUrls, // Use processed URLs
              },
              budget: selectedBudget ? {
                placement: 'unknown',
                estimatedSize: 'unknown', // These fields seem unused in UI, defaulting
