...
export default function PublicBookingPage() {
  ...
  if (artistLoading) {
    return (
      <div className="app-document fixed inset-0 overflow-y-auto bg-background flex items-center justify-center">
  ...
  if (artistError || !artist) {
    return (
      <div className="app-document fixed inset-0 overflow-y-auto bg-background flex flex-col items-center justify-center p-6 text-center">
  ...
  if (pageState === "success") {
    return (
      <div className="app-document fixed inset-0 overflow-y-auto bg-background flex items-center justify-center p-4">
        <motion.div
  ...
  return (
    <div className="app-document fixed inset-0 overflow-y-auto bg-background">
      <motion.div
