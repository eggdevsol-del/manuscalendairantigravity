import { useOriginalCalendarController } from "./hooks/useOriginalCalendarController";
...
export default function CalendarAgendaPage() {
  const controller = useOriginalCalendarController();
    ...
    <PageShell>
      ...
      >
        ...
        <div
          ...
          onClick={
            controller.isBreakdownOpen ? controller.toggleBreakdown : undefined
          }
        >
          {/* Sticky Header Zone */}
          <div
