...
export default function SupplierSignup() {
  ...
  const [accountType, setAccountType] = useState<"artist" | "supplier">(
    "supplier"
  );
          ...
          if (result.exists && result.isFunnelClient) {
            ...
            if (accountType === "supplier") {
              merchantRegisterMutation.mutate({
                ...
                businessName,
                country:
                  country === "New Zealand" || country === "NZ" ? "NZ" : "AU",
        ...
        <CardContent>
          ...
          {!isClientRole && (
            <div className={tokens.authFlow.toggleContainer}>
              <button
                ...
                className={
                  accountType === "artist"
                    ? tokens.authFlow.toggleButtonActive
                    : tokens.authFlow.toggleButton
                }
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="name">
                Full Name{" "}
                <span className="text-[var(--color-status-danger-text)]">
                  *
                </span>
              </Label>
              <div className="relative">
