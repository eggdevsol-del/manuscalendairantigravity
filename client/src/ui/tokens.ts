...
export const tokens = {
    ...
    bgGradient: "fixed inset-0 w-full h-[100dvh] bg-[radial-gradient(circle_at_top_right,rgba(23,44,104,0.4),rgba(2,5,17,1)_60%)]",

    // 2. Sheets
    // Main sheet (Dashboard, Calendar) - extends past bottom
    sheetMain: {
        container: "flex-1 z-20 flex flex-col bg-transparent backdrop-blur-[32px] rounded-t-[2.5rem] shadow-[inset_0_1px_0_0_rgba(255,255,255,0.02)] overflow-hidden relative",
    ...
    sheetSecondary: {
        ...
        container: "flex-1 z-20 flex flex-col bg-transparent rounded-t-[2.5rem] shadow-[inset_0_1px_0_0_rgba(255,255,255,0.02)] overflow-hidden relative will-change-transform",
        glass: "bg-transparent rounded-t-[2.5rem] shadow-[inset_0_1px_0_0_rgba(255,255,255,0.02)]",
