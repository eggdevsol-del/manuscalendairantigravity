...
export const appointmentLogs = mysqlTable(
  "appointment_logs",
  {
    id: int().primaryKey().autoincrement(),
    appointmentId: int()
    ...
    oldValue: text(), // JSON
    newValue: text(), // JSON
    performedBy: varchar({ length: 64 })
      .notNull()
      .references(() => users.id, { onDelete: "cascade" }),
    createdAt: timestamp({ mode: "string" }).default(sql`(now())`),
  },
  table => [index("log_appt_idx").on(table.appointmentId)]
);
...
export const artistSettings = mysqlTable(
  "artistSettings",
  {
    id: int().primaryKey().autoincrement(),
...
export const clientContent = mysqlTable(
  "client_content",
  {
    id: int().primaryKey().autoincrement(),
...
export const fileStorage = mysqlTable(
  "file_storage",
  {
...
export const messages = mysqlTable(
  ...
  table => [index("msg_conversation_idx").on(table.conversationId)]
);
...
export const notificationSettings = mysqlTable(
  ...
  table => [unique("userId").on(table.userId)]
);
...
export const portfolioLikes = mysqlTable(
  "portfolio_likes",
  {
    id: int().primaryKey().autoincrement(),
    portfolioId: int()
  ...
  table => [unique("user_portfolio_like").on(table.userId, table.portfolioId)]
);

export const quickActionButtons = mysqlTable(
  "quickActionButtons",
  {
    id: int().primaryKey().autoincrement(),
    userId: varchar({ length: 64 })
...
export const socialMessageSync = mysqlTable(
  "socialMessageSync",
  {
    id: int().primaryKey().autoincrement(),
    artistId: varchar({ length: 64 })
...
export const studioMembers = mysqlTable(
  "studio_members",
  {
    ...
    role: mysqlEnum(["owner", "manager", "artist", "apprentice"])
      .default("artist")
      .notNull(),
    paymentModel: mysqlEnum(["commission", "rent", "dynamic", "none"])
      .default("commission")
      .notNull(),
    commissionPct: int().default(30),
    weeklyChairRentCents: int().default(35000),
    dynamicStartingPct: int().default(35),
    status: mysqlEnum(["active", "pending_invite", "declined", "removed"])
      .default("active")
      .notNull(),
...
export const studioArrears = mysqlTable(
  "studio_arrears",
  {
    ...
    status: mysqlEnum(["pending", "deducted", "waived"])
      .default("pending")
      .notNull(),
...
export const rctiInvoices = mysqlTable(
  "rcti_invoices",
  {
    ...
    gstAmountCents: int().default(0).notNull(),
    settlementAmountCents: int().notNull(),
    paymentModel: varchar({ length: 50 }).notNull(),
    pdfUrl: text(),
    createdAt: timestamp({ mode: "string" }).default(sql`(now())`),
  },
  table => [unique("rcti_invoices_invoiceNumber_unique").on(table.invoiceNumber)]
);

export type Studio = InferSelectModel<typeof studios>;
export type StudioMember = InferSelectModel<typeof studioMembers>;
export type StudioTransaction = InferSelectModel<typeof studioTransactions>;
export type StudioArrears = InferSelectModel<typeof studioArrears>;
export type RctiInvoice = InferSelectModel<typeof rctiInvoices>;
...
export const issuedVouchers = mysqlTable(
  "issued_vouchers",
  {
    id: int().primaryKey().autoincrement(),
    templateId: int()
      .notNull()
      .references(() => voucherTemplates.id, { onDelete: "cascade" }),
    artistId: varchar({ length: 64 })
      .notNull()
      .references(() => users.id, { onDelete: "cascade" }),
    clientId: varchar({ length: 64 })
    ...
    status: mysqlEnum(["active", "redeemed", "expired"])
      .default("active")
      .notNull(),
...
export const moodboardItems = mysqlTable(
  "moodboard_items",
  {
    id: int().primaryKey().autoincrement(),
    moodboardId: int()
...
export type InsertSocialMessageSync = InferInsertModel<
  typeof socialMessageSync
>;
...
export type InsertNotificationOutbox = InferInsertModel<
...
export type InsertQuickActionButton = InferInsertModel<
  typeof quickActionButtons
>;
export type SelectQuickActionButton = InferSelectModel<
  typeof quickActionButtons
>;
export type InsertNotificationTemplate = InferInsertModel<
  typeof notificationTemplates
>;
export type SelectNotificationTemplate = InferSelectModel<
  typeof notificationTemplates
>;

export const usersRelations = relations(users, ({ many }) => ({
  artistAppointments: many(appointments, {
    relationName: "artist_appointments",
  }),
  clientAppointments: many(appointments, {
    relationName: "client_appointments",
  }),
  artistConsultations: many(consultations, {
    relationName: "artist_consultations",
  }),
  clientConsultations: many(consultations, {
    relationName: "client_consultations",
  }),
  portfolios: many(portfolios),
  portfolioLikes: many(portfolioLikes),
  voucherTemplates: many(voucherTemplates),
  issuedVouchersAsArtist: many(issuedVouchers, {
    relationName: "artist_issued_vouchers",
  }),
  issuedVouchersAsClient: many(issuedVouchers, {
...
export const appointmentLogsRelations = relations(
  appointmentLogs,
  ({ one }) => ({
...
export const taskCompletions = mysqlTable(
  "task_completions",
  {
    ...
    taskDomain: mysqlEnum(["business", "social", "personal"])
      .default("business")
      .notNull(),
 ...
 */
export const weeklyAnalytics = mysqlTable(
  "weekly_analytics",
  {
    id: int().primaryKey().autoincrement(),
    artistId: varchar({ length: 64 })
...
export const dashboardSettings = mysqlTable(
  "dashboard_settings",
  {
    ...
    preferredEmailClient: mysqlEnum([
      "default",
      "gmail",
      "outlook",
      "apple_mail",
  ...
  table => [unique("artist_dashboard_settings").on(table.artistId)]
);
 ...
 */
export const activeTasks = mysqlTable(
  "active_tasks",
  {
    id: int().primaryKey().autoincrement(),
    artistId: varchar({ length: 64 })
...
export type InsertDashboardSettings = InferInsertModel<
  typeof dashboardSettings
>;
export type SelectDashboardSettings = InferSelectModel<
  typeof dashboardSettings
>;
 ...
 */
export const artistPublicProfile = mysqlTable(
  "artist_public_profile",
  {
    ...
    enabledSteps: text().default(
      '["intent","contact","style","budget","availability"]'
    ),

    // Style options available (JSON array)
    styleOptions: text().default(
    ...
    budgetRanges: text().default(
      '[{"label":"Under $500","min":0,"max":500},{"label":"$500-$1,000","min":500,"max":1000},{"label":"$1,000-$2,500","min":1000,"max":2500},{"label":"$2,500-$5,000","min":2500,"max":5000},{"label":"$5,000-$10,000","min":5000,"max":10000},{"label":"$10,000+","min":10000,"max":null}]'
    ),
...
export const leads = mysqlTable(
  "leads",
  {
    ...
    priorityTier: mysqlEnum(["tier1", "tier2", "tier3", "tier4"]).default(
      "tier2"
    ),
 ...
 */
export const funnelSessions = mysqlTable(
  "funnel_sessions",
  {
 ...
 */
export const leadActivityLog = mysqlTable(
  "lead_activity_log",
  {
    id: int().primaryKey().autoincrement(),
    leadId: int()
    ...
    performedBy: varchar({ length: 64 }).references(() => users.id, {
      onDelete: "set null",
    }),
    performedByType: mysqlEnum(["artist", "client", "system"]).default(
      "system"
    ),

    createdAt: timestamp({ mode: "string" }).default(sql`(now())`),
  },
  table => [index("idx_lead_activity").on(table.leadId, table.createdAt)]
);

// Type exports for funnel tables
export type InsertArtistPublicProfile = InferInsertModel<
  typeof artistPublicProfile
>;
export type SelectArtistPublicProfile = InferSelectModel<
  typeof artistPublicProfile
>;
...
export const artistPublicProfileRelations = relations(
  artistPublicProfile,
  ({ one }) => ({
    artist: one(users, {
...
export const leadActivityLogRelations = relations(
  leadActivityLog,
  ({ one }) => ({
    lead: one(leads, {
 ...
 */
export const promotionTemplates = mysqlTable(
  "promotion_templates",
  {
    id: int().primaryKey().autoincrement(),
    artistId: varchar({ length: 64 })
    ...
    autoApplyTrigger: mysqlEnum(["none", "new_client", "birthday"])
      .default("none")
      .notNull(),
  ...
  table => [index("idx_artist_templates").on(table.artistId, table.type)]
);
 ...
 */
export const issuedPromotions = mysqlTable(
  "issued_promotions",
  {
    id: int().primaryKey().autoincrement(),
    templateId: int()
      .notNull()
      .references(() => promotionTemplates.id, { onDelete: "cascade" }),
    artistId: varchar({ length: 64 })
      .notNull()
      .references(() => users.id, { onDelete: "cascade" }),
    clientId: varchar({ length: 64 }).references(() => users.id, {
      onDelete: "set null",
    }), // Null for auto-apply promotions
    ...
    // Redemption tracking
    redeemedAt: timestamp({ mode: "string" }),
    redeemedOnAppointmentId: int().references(() => appointments.id, {
      onDelete: "set null",
    }),
  ...
  table => [
    ...
    index("idx_auto_apply").on(
      table.isAutoApply,
      table.autoApplyStartDate,
      table.autoApplyEndDate
    ),
...
export const promotionRedemptions = mysqlTable(
  "promotion_redemptions",
  {
    ...
    promotionId: int()
      .notNull()
      .references(() => issuedPromotions.id, { onDelete: "cascade" }),
    appointmentId: int()
      .notNull()
      .references(() => appointments.id, { onDelete: "cascade" }),
...
export type InsertPromotionTemplate = InferInsertModel<
  typeof promotionTemplates
>;
export type SelectPromotionTemplate = InferSelectModel<
  typeof promotionTemplates
>;
...
export type InsertPromotionRedemption = InferInsertModel<
  typeof promotionRedemptions
>;
export type SelectPromotionRedemption = InferSelectModel<
  typeof promotionRedemptions
>;
export type InsertPushSubscription = InferInsertModel<typeof pushSubscriptions>;
export type InsertPaymentMethodSettings = InferInsertModel<
  typeof paymentMethodSettings
>;
...
export const promotionTemplatesRelations = relations(
  promotionTemplates,
  ({ one, many }) => ({
    artist: one(users, {
...
export const issuedPromotionsRelations = relations(
  issuedPromotions,
  ({ one, many }) => ({
...
export const paymentMethodSettings = mysqlTable(
  ...
  table => [index("pms_artist_idx").on(table.artistId)]
);

export const consentForms = mysqlTable(
  "consent_forms",
  {
    id: int().primaryKey().autoincrement(),
    appointmentId: int().references(() => appointments.id, {
    ...
    status: mysqlEnum("consent_status", ["pending", "signed"])
      .default("pending")
      .notNull(),
    createdAt: timestamp({ mode: "string" }).default(sql`(now())`),
    updatedAt: timestamp({ mode: "string" }).default(sql`(now())`),
...
export const procedureLogs = mysqlTable(
  "procedure_logs",
  {
    id: int().primaryKey().autoincrement(),
    appointmentId: int()
...
export const systemLogs = mysqlTable(
  ...
  {
    id: int().primaryKey().autoincrement(),
    level: mysqlEnum("level", ["debug", "info", "warn", "error"])
      .default("info")
      .notNull(),
...
export const orders = mysqlTable("orders", {
  ...
  shopifyOrderId: varchar({ length: 100 }),
  createdAt: timestamp().notNull().defaultNow(),
  updatedAt: timestamp().notNull().defaultNow(),
});
...
export const merchants = mysqlTable("merchants", {
  ...
  country: varchar({ length: 2 }).default("AU").notNull(),
  abn: varchar({ length: 20 }),
  nzbn: varchar({ length: 20 }),
  contactName: varchar({ length: 255 }),
  phone: varchar({ length: 50 }),
  address: text(),
  integrationType: mysqlEnum(["shopify", "native"]).default("native"),
  shopifyDomain: varchar({ length: 255 }),
  shopifyToken: text(),
  shopifyShopId: varchar({ length: 100 }),
  stripeAccountId: varchar({ length: 100 }),
  xeroTenantId: varchar({ length: 100 }),
...
export const purchaseOrderItems = mysqlTable("purchaseOrderItems", {
  ...
  sku: varchar({ length: 100 }),
  quantityOrdered: int().notNull(),
  quantityReceived: int().default(0),
  unitCostCents: int().notNull(),
...
export const stockAdjustments = mysqlTable("stockAdjustments", {
  ...
  referenceId: int(),
  adjustedBy: varchar({ length: 100 }),
  createdAt: timestamp().notNull().defaultNow(),
});

export const merchantAccountingLog = mysqlTable("merchantAccountingLog", {
  id: int().autoincrement().primaryKey(),
  merchantId: int()
    .notNull()
    .references(() => merchants.id, { onDelete: "cascade" }),
